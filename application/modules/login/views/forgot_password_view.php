  ...
  <body class="login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <p class="login-box-msg">Enter the mail address that you signed in from</p>

         <div class="form-group has-feedback">

         

            <?php echo form_open('login/forgot_password_email_sent')?>

            <input type="email" class="form-control" name="email" placeholder="sample@hotmail.com"/>
